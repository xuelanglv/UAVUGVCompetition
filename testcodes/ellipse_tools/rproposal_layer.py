...
from ellipse_gpu_nms import ellipse_gpu_nms
...
class ProposalLayer(caffe.Layer):
    ...
    def forward(self, bottom, top):
        ...
        #print 'bbox_deltas:', bbox_deltas.astype(float)
        ...
        keep = ellipse_gpu_nms(np.hstack((proposals, scores)), nms_thresh,cfg.GPU_ID) # D
